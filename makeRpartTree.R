createRpartTree = function(dataset, labels) {
  ...
  tree = rpart(labels~., data = dataset, method = 'class')
  ...
  # U nas to bêdzie klasa '1' - to jej pstwo, znajdzie sie w node w drugim wierszu
  # +100 - Add 100 to any of the above to also display the percentage of observations in the node.
  # Na rysunku: pierwszy wiersz drugi to pstwo klasy 1, trzeci to pstwo spelnienia warunku wyzej
